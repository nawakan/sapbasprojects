sap.ui.define(
	...
	function(Control,MessageBox) {
		"use strict";
		return Control.extend("sap.fe.demo.bookinganalysis.control.GoogleMap", {
			metadata: {
				properties: {
			...
			onAfterRendering: function() {
				...
				var sBaseUrl = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDOqJZjBabVnjDA_2g6b37Bdx3e9QXUj1c', 
